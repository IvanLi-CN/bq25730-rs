...
-> Result<(), bq25730_async_rs::errors::Error<embedded_hal::i2c::ErrorKind>> {
    ...
    // Test case 1: 0mA
    let current_0ma = bq25730_async_rs::data_types::ChargeCurrent {
        milliamps: 0,
        rsns_bat,
    };
    ...
    let expectations_0ma = [
        ...
        I2cTransaction::write(
            BQ25730_I2C_ADDRESS,
            vec![Register::ChargeCurrent as u8, d1_d0_0ma << 6],
        ),
        // Read MSB (0x03)
        I2cTransaction::write_read(
            BQ25730_I2C_ADDRESS,
            vec![Register::ChargeCurrentMsb as u8],
            vec![0x00],
        ), // Initial MSB value
        // Write MSB (0x03)
        I2cTransaction::write(
            BQ25730_I2C_ADDRESS,
            vec![Register::ChargeCurrentMsb as u8, d6_d2_0ma],
        ),
    ];
    ...
    let current_8192ma = bq25730_async_rs::data_types::ChargeCurrent {
        milliamps: 8192,
        rsns_bat,
    };
    ...
    let expectations_8192ma = [
        ...
        I2cTransaction::write(
            BQ25730_I2C_ADDRESS,
            vec![Register::ChargeCurrent as u8, d1_d0_8192ma << 6],
        ),
        I2cTransaction::write_read(
            BQ25730_I2C_ADDRESS,
            vec![Register::ChargeCurrentMsb as u8],
        ...
        I2cTransaction::write(
            BQ25730_I2C_ADDRESS,
            vec![Register::ChargeCurrentMsb as u8, d6_d2_8192ma],
        ),
    ];
    let i2c_8192ma = I2cMock::new(&expectations_8192ma);
    let mut charger_8192ma =
        bq25730_async_rs::Bq25730::new(i2c_8192ma, BQ25730_I2C_ADDRESS, config);
    charger_8192ma.set_charge_current(current_8192ma)?;
    charger_8192ma.i2c.done();

    // Test case 3: 2560mA
    // For 5mOhm, LSB = 128mA. 2560mA / 128mA = 20 (0x14)
    let current_2560ma = bq25730_async_rs::data_types::ChargeCurrent {
        milliamps: 2560,
        rsns_bat,
    };
    ...
    let expectations_2560ma = [
        ...
        I2cTransaction::write(
            BQ25730_I2C_ADDRESS,
            vec![Register::ChargeCurrent as u8, d1_d0_2560ma << 6],
        ),
        I2cTransaction::write_read(
            BQ25730_I2C_ADDRESS,
            vec![Register::ChargeCurrentMsb as u8],
        ...
        I2cTransaction::write(
            BQ25730_I2C_ADDRESS,
            vec![Register::ChargeCurrentMsb as u8, d6_d2_2560ma],
        ),
    ];
    let i2c_2560ma = I2cMock::new(&expectations_2560ma);
    let mut charger_2560ma =
        bq25730_async_rs::Bq25730::new(i2c_2560ma, BQ25730_I2C_ADDRESS, config);
...
-> Result<(), bq25730_async_rs::errors::Error<embedded_hal::i2c::ErrorKind>> {
    ...
    assert_eq!(
        ...
        bq25730_async_rs::data_types::ChargeCurrent {
            milliamps: 0,
            rsns_bat
        }
    );
