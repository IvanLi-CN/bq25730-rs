...
use bq25730_async_rs::{
    ...
    data_types::{ChargeCurrent, ChargeOption0, ChargeVoltage, Config, SenseResistorValue},
...
-> Result<(), bq25730_async_rs::errors::Error<embedded_hal::i2c::ErrorKind>> {
    ...
    let current_8192ma = ChargeCurrent {
        milliamps: 8192,
        rsns_bat,
    };
    ...
    let current_2560ma = ChargeCurrent {
        milliamps: 2560,
        rsns_bat,
    };
...
-> Result<(), bq25730_async_rs::errors::Error<embedded_hal::i2c::ErrorKind>> {
    ...
    charger.set_charge_voltage(ChargeVoltage(1024))?;
...
-> Result<(), bq25730_async_rs::errors::Error<embedded_hal::i2c::ErrorKind>> {
    ...
    assert_eq!(charger.read_charge_voltage()?, ChargeVoltage(1024));
