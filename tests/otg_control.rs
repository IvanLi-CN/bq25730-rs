...
use bq25730_async_rs::{Error, data_types::*, registers::Register}; // Removed Rsns from here
...
fn test_set_otg_current() -> Result<(), Error<ErrorKind>> {
    ...
    let expectations_0ma = [
        ...
        I2cTransaction::write(
            BQ25730_I2C_ADDRESS,
            vec![Register::OTGCurrentMsb as u8, 0x80 | raw_0ma],
        ),
    ];
    ...
    let expectations_1000ma = [
        ...
        I2cTransaction::write(
            BQ25730_I2C_ADDRESS,
            vec![Register::OTGCurrentMsb as u8, raw_1000ma],
        ),
    ];
    let i2c_1000ma = I2cMock::new(&expectations_1000ma);
    let mut charger_1000ma =
        bq25730_async_rs::Bq25730::new(i2c_1000ma, BQ25730_I2C_ADDRESS, config);
    charger_1000ma.set_otg_current(current_1000ma)?;
    charger_1000ma.i2c.done();

    // Test case 3: 12700mA (raw = 127 (0x7F) for 5mOhm)
    let current_12700ma = OtgCurrent {
        milliamps: 12700,
        rsns_bat,
    };
    ...
    let expectations_12700ma = [
        ...
        I2cTransaction::write(
            BQ25730_I2C_ADDRESS,
            vec![Register::OTGCurrentMsb as u8, raw_12700ma],
        ),
    ];
    let i2c_12700ma = I2cMock::new(&expectations_12700ma);
    let mut charger_12700ma =
        bq25730_async_rs::Bq25730::new(i2c_12700ma, BQ25730_I2C_ADDRESS, config);
